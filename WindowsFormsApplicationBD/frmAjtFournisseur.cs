...
{
    public partial class frmAjtFournisseur : Form
    {
        SqlConnection cnx;
        SqlCommand cmd;
        SqlDataAdapter adap;
        ...
        private void BTajout_Click_1(object sender, EventArgs e)
        {
            dtr = tab.NewRow();
            dtr[0] = textCode.Text;
        ...
        private void BTsup_Click_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BTeng_Click_1(object sender, EventArgs e)
        {
            try
            {
